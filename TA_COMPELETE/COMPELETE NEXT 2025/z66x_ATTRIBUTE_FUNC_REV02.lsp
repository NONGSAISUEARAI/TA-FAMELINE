...
(setq sdss_ename_ (car (entsel "specify Object")))
(setq sdss_obj_ (vlax-ename->vla-object sdss_ename_))

 (vlax-dump-object (car (vlax-invoke sdss_obj_ 'getdynamicblockproperties)))
(LM:getdynprops sdss_obj_ )
